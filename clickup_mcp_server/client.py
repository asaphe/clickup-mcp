...
# A transport error leaves it unknown whether the server applied the request.
_TRANSPORT_RETRY_SAFE_METHODS = frozenset({"GET", "DELETE"})
        ...
        for attempt in range(settings.max_retries + 1):
            try:
                ...
                if (
                    ...
                    or method not in _TRANSPORT_RETRY_SAFE_METHODS
                ):
                    raise
